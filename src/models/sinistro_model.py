...
class SinistroModel(Document):  
    ...
    status = StringField(required=True, choices=["Aberto", "Análise Manual Necessária", "Negado", "Aprovado"])
    ...
    policy_type = StringField(required=True, choices = ["Sedan - All Perils", "Sedan - Collision", "Sport - Collision", "Utility - All Perils", "Utility - Collision", "Sedan - Liability"])
